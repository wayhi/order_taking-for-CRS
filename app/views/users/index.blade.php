...
<div class='col-md-offset-5 col-md-6 col-lg-6'>
	<a class='btn btn-success btn-sm' href="{{URL::route('users.create')}}">新增</a>
	<a class='btn btn-primary btn-sm' href="{{URL::route('users.import')}}">导入用户列表...</a>
